...
<div class="d-flex justify-content-between align-items-center mb-3">
    <div>
        ...
        <div class="text-muted">Tìm theo tên món hoặc nguyên liệu, chủ cửa hàng mới được chỉnh sửa</div>
    </div>
</div>
            ...
            <div class="card widget-card h-100 text-body">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start gap-2 mb-1">
                        <div class="fw-bold fs-5">{{ $mon->ten_mon }}</div>
                        <div class="d-flex gap-2">
                            <a class="btn btn-outline-secondary btn-sm" href="{{ route('cong-thuc.show', $mon) }}">Xem</a>
                            @if($canManage)
                                <a class="btn btn-outline-primary btn-sm" href="{{ route('cong-thuc.edit', $mon) }}">Sửa</a>
                            @endif
                        </div>
                    </div>
    ...
    @empty
        <div class="col-12">
            <div class="card page-card">
                <div class="card-body text-muted text-center">Không có món phù hợp.</div>
            </div>
        </div>
    @endforelse
</div>
