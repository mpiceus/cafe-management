...
<div class="card page-card mb-3">
    <div class="card-body">
        <form class="row g-3" method="GET">
            <div class="col-md-6"><input class="form-control" name="tu_khoa" value="{{ $filters['tu_khoa'] ?? '' }}" placeholder="Tìm nguyên liệu"></div>
            <div class="col-md-3">
            ...
            <div class="col-md-3 d-grid"><button class="btn btn-outline-primary">Lọc</button></div>
        </form>
    </div>
</div>
            ...
            <tbody>
                @forelse($nguyenLieus as $nl)
                    <tr>
                        ...
                        <td class="text-end"><a class="btn btn-outline-primary btn-sm" href="{{ route('nguyen-lieu.edit', $nl) }}">Sửa</a></td>
                    </tr>
                @empty
                    <tr><td colspan="7" class="text-center text-muted py-4">Chưa có nguyên liệu.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
